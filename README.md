# Vercel Apps on GitHub Pages

Static GitHub Pages launch bundle for the workspace Vercel apps.

## Apps

- CodiesCatchCompass: `apps/codies-catch-compass/`
- DoodleDrift: `apps/doodledrift/`
- Quantum Portfolio Rebuild: `apps/quantum-portfolio-rebuild/`
